  ...
  return (
    <div className="m-8">
      ...
      <div className="flex flex-nowrap gap-4 overflow-x-auto">
        {cast.map((castMember) => {
          const imgSrc = castMember.profile_path ? `${imagePath}${castMember.profile_path}` : "https://via.placeholder.com/150x200";

          return (
            <div key={castMember.id} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6 flex-shrink-0">
              <Image src={imgSrc} alt={castMember.name} className="w-full h-auto" width={150} height={200} layout="fixed" />
